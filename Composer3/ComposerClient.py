...
FILE_PORT = 27008
COMPOSER_PORT = 47006
SCHEDULING_CENTER = '35.196.113.72'
...
def scheduler_listen():
    ...
    try:
        ...
        while 1:
            ...
            conn.close()
            if nodeDataset:
                print "==> Received scheduling task..."
...
if __name__=='__main__':
    ...
    if os.path.exists("Files"):
        ...
        try:
            ...
            print "==> Exception:", e
    '''
    # Thread for listening same node scheduler
    try:
    ...
    # Thread for listening for scheduler
    '''
    try:
        schedulerListener = MainFunc()
        schListen = threading.Thread(target=schedulerListener.scheduler, args=(LISTEN_HOST, SCHEDULER_PORT))
        schListen.start()
    except Exception, e:
