...
def groupHandling(groupItem, threadID):
    ...
    with open('statistic.txt', 'a+') as f:
        f.write(str(time.time()-Var.INITIAL_TIME) + ', ' + str(len(groupItem)) + '\n')
...
if __name__=='__main__':
    ...
    if len(globalList) != 0:
        ...
        while 1:
            ...
            print "==> Current global list length: " + str(length) + ", group size: " + str(Var.GROUP_SIZE)
